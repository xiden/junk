...
namespace Jk {
	...
	public struct Rangef {
		...
		public Rangef(element v1, element v2) {
			V1 = v1;
			V2 = v2;
		}
		...
		public Rangef GetNormalized() {
			if (V1 <= V2)
				return new Rangef(V1, V2);
			else
				return new Rangef(V2, V1);
		}
		...
		/// 自分と指定された RangeD 共に V1＜V2でなければならない
		/// </summary>
		public void Union(ref Rangef r) {
			if (r.V1 < V1)
				V1 = r.V1;
			if (V2 < r.V2)
				V2 = r.V2;
		...
		/// 自分と指定された RangeD 共に V1＜V2でなければならない
		/// </summary>
		public void Intersect(Rangef r) {
			if (V1 < r.V1)
				V1 = r.V1;
			if (r.V2 < V2)
				V2 = r.V2;
		...
		/// 自分と指定された RangeD 共に V1＜V2でなければならない
		/// </summary>
		public void Intersect(ref Rangef r) {
			if (V1 < r.V1)
				V1 = r.V1;
			if (r.V2 < V2)
				V2 = r.V2;
		...
		public Rangef CalcChangeRate(Rangef r) {
			element s = this.Size;
			if (s == 0)
				return new Rangef();
			return new Rangef((r.V1 - this.V1) / s, (r.V2 - this.V2) / s);
		}
		...
		public void ApplyChangeRate(Rangef cr) {
			element s = this.Size;
			this.V1 += cr.V1 * s;
			this.V2 += cr.V2 * s;
		}
		...
		/// <returns>true=範囲内 false=範囲外</returns>
		/// <remarks>呼び出し時にはV1＜＝V2でなければならない</remarks>
		public bool CheckInclusion(Rangef r) {
		...
		/// <remarks>呼び出し時にはV1＜＝V2でなければならない</remarks>
		public bool CheckIntersect(Rangef r) {
		...
		/// <returns>true=接触している、false=接触していない</returns>
		/// <remarks>呼び出し時にはV1＜＝V2でなければならない</remarks>
		public bool CheckIntersect(ref Rangef r) {
			return this.V1 <= r.V2 && r.V1 <= this.V2;
		}
